...
(custom-set-variables
 ...
 '(package-selected-packages
   '(i-ching org-static-blog ox-hugo org-protocol whole-line-or-region use-package slime recently org-protocol-jekyll org-journal nov mu4e-views modus-vivendi-theme modus-themes modus-operandi-theme markdown-mode elfeed auto-compile)))
(custom-set-faces
